...
for s = 1, screen.count() do
    ...
    local my_right_widgets = _.concat(cpu_icon, cpu_widgets, mem_icon, mem_widget, separator, vol_widget, separator, bat_widget, separator)
...
globalkeys = awful.util.table.join(
	awful.key({ }, "F12", function () awful.util.spawn("/usr/bin/slock") end),
